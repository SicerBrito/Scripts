# Este script utiliza la biblioteca pygame para crear una animación simple en la que un círculo rojo sigue al cursor del mouse en la pantalla, y se duplica cada vez que colisiona con el mouse.
